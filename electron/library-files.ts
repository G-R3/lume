...
import type { tracks } from "./database/schema";
...
type ExtractedTrack = TrackMetadata & {
  artwork: { data: Uint8Array; id: string; mediaType: string } | null;
  fileSize: number;
  kind: "changed";
  modifiedAt: number;
  path: string;
...
type StoredTrackMetadata = Pick<typeof tracks.$inferSelect, "fileSize" | "modifiedAt">;
